        ...
        <div class="main">
            ...
            <div class="course-tab">
                <ul class="tab-list">
                    ...
                    <li :class="tabIndex==3?'active':''" @click="tabIndex=3">学生评论(10)</li>
                ...
                <div class="course-tab-list">
                    ...
                    <div class="tab-item" v-if="tabIndex==2">
                        ...
                        <div class="chapter-item" v-for="chapter in chapter_list">
                            <p class="chapter-title"><img src="/static/image/1.svg" alt="">{{ chapter.name }}</p>
                            <ul class="lesson-list">
                                <li class="lesson-item" v-for="lesson in chapter.coursesections">
                                    <p class="name"><span class="index">1-1</span>{{ lesson.name }}
...
export default {
    ...
    data() {
        return {
            ...
            playerOptions: {
                ...
                poster: "../static/image/01.png", //视频封面图
    ...
    methods: {
        ...
        get_course_detail() {
            this.$axios({
                url: this.$settings.HOST + "courseapp/detail/" + this.course_id + "/",
                method: 'get',
            }).then(res => {
        ...
        //获取课程对应章节
        get_chapter_lesson() {
            this.$axios.get(this.$settings.HOST + "courseapp/chapter/", {
                params: {
        ...
        add_cart(){
            ...
            this.$axios.post(this.$settings.HOST+"cartapp/option/",{
                course_id:this.course_id
            },{
                headers:{
                    //购物车需要认证，需要token才能请求到后台
