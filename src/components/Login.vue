<template>
    <div class="login box">
        ...
        <div class="login">
            ...
            <div class="login_box">
                <div class="title">
                    <span @click="login_type=0" :class="login_type===0?'active':''">密码登录</span>
                    <span @click="login_type=1" :class="login_type===1?'active':''">短信登录</span>
                </div>
    ...
    methods: {
        ...
        handlerPopup(captchaObj) {
            ...
            captchaObj.onSuccess(function () {
                ...
                self.$axios({
                    url: self.$settings.HOST + "userapp/captcha/",
                    method: "post",
                    data: {
        ...
        get_captcha() {
            // 向后端服务器发起请求获取验证码
            this.$axios({
                url: this.$settings.HOST + "userapp/captcha/",
                method: 'get',
                params: {
        ...
        u_login() {
            this.$axios({
                url: this.$settings.HOST + "userapp/login/",
                method: "post",
                data: {
                    username: this.username,
