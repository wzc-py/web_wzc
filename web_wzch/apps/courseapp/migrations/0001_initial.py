# Generated by Django 2.0.6 on 2021-01-25 11:48
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('pub_date', models.DateField(auto_now_add=True, verbose_name='发布日期')),
                ('course', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='coursechapters', to='courseapp.Course', verbose_name='课程名称')),
            ],
            options={
                'verbose_name': '课程章节',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('chapter', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='coursesections', to='courseapp.CourseChapter', verbose_name='课程章节')),
                ('course', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='course_lesson', to='courseapp.Course', verbose_name='课程')),
            ],
            options={
                'verbose_name': '课程课时',
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='courseapp.CourseCategory', verbose_name='课程分类'),
        ),
        migrations.AddField(
            model_name='course',
            name='teacher',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='courseapp.Teacher', verbose_name='授课老师'),
        ),
    ]
